...
@section("title") List Book Trash @endsection
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <ul class="nav nav-pills card-header-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{route('books.trash')}}">Trash</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <form onsubmit="return confirm('Delete this book permanently?')" class="d-inline" action="{{route('books.destroy', [$book->id])}}" method="POST">
                    @csrf
