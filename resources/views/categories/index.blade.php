...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$categori->slug}}</td>
            <td>
                <a class="btn btn-info text-white btn-sm" href="{{route('categories.edit', [$categori->id])}}">Edit</a>

                <form onsubmit="return confirm('Delete this category?')" class="d-inline" action="{{route('categories.destroy', [$categori->id])}}" method="POST">
                    @csrf
