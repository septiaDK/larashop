...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get("save_action") == "PUBLISH") {
            return redirect()->route('books.index')->with('status', 'Book sucessfully saved and published');
        } else {
    ...
    public function trash(Request $request)
    {
        ...
        $deleted_book = \App\Models\Book::onlyTrashed()->where('title', 'LIKE', "%$keyword%")->paginate(10);
